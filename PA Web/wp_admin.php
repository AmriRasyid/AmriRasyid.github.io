        ...
        <div class="list-table center" style="overflow-x: auto;">
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="6" class="thead">
                            <h3 class="center">Weapon</h3>
                        </th>
                        <th style="width: 20px;" colspan="2">
                            <a href="wp_form.php" class="tambah">Tambah</a>
                            <a href="valo_admin.php" class="tambah">Back</a>
                        </th>
                    </tr>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    <?php
                    require "config.php";
                    $query = mysqli_query($db, "SELECT * FROM senjata");
                    $i = 1;
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$row['deskripsi_senjata']?></td>
                            <td><img src="gambar/<?=$row['gambar']?>" alt="" width="100px"></td>
                            <td class="edit">
                                <a href="edit_wp.php?id=<?=$row['id']?>">
